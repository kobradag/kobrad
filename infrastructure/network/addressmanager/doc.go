/*
Package addressmanager implements concurrency safe Kobra address manager.

# Address Manager Overview

In order maintain the peer-to-peer Kobra network, there needs to be a source
of addresses to connect to as nodes come and go. The Kobra protocol provides
