...
func (x *KobradMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "KobradMessage_Addresses is nil")
	}
...
func (x *KobradMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
