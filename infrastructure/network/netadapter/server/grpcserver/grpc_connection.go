...
type grpcStream interface {
	Send(*protowire.KobradMessage) error
	Recv() (*protowire.KobradMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.KobradMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.KobradMessage) error {
